...
public class FormWithIcon extends C0818e {
    private void m11411j() {
        m4362a((Toolbar) findViewById(C1142R.id.toolbar));
        m4370f().mo760a(null);
        m4370f().mo761a(true);
        C2746d.m12253a((Activity) this, (int) C1142R.color.pink_900);
    }

    protected void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) C1142R.layout.activity_form_with_icon);
        m11411j();
    }
